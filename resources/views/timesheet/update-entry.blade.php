...
@section('content')
    <div class="navbar-timesheet">
        ...
        <form method="post" action="{{route('timesheet-entry.update',$ent->id)}}">
            @csrf
            <div class="timesheet-row">
                ...
                <div class="navbar-date">
                    <input type="date" value="{{$ent->date}}" class="input-date" name="date">
                </div>
            </div>
            <div class="timesheet-row-text">
                <div class="navbar-text">
                    ...
                    <input type="text" placeholder="please enter details" value="{{$ent->description}}" name="description">
                </div>
            </div>
            @endforeach
